#!/usr/bin/env python3
"""
TAIRID Hubble gate window probe clean v2.
...
OUTDIR = Path("hubble_gate_window_probe_clean_v2_outputs")
...
(OUTDIR / "hubble_gate_window_probe_clean_v2_summary.json").write_text(json.dumps(summary, indent=2))

with open(OUTDIR / "hubble_gate_window_probe_clean_v2_summary.csv", "w", newline="") as f:
    writer = csv.writer(f)
...
with open(OUTDIR / "hubble_gate_window_probe_clean_v2_summary.txt", "w") as f:
    f.write("TAIRID Hubble gate window probe clean v2\n\n")
...
plt.xlabel("z")
plt.ylabel("G(z)")
plt.title("Hubble gate window probe clean v2: distance ratio")
plt.legend(fontsize=8)
plt.tight_layout()
plt.savefig(OUTDIR / "hubble_gate_window_clean_v2_ratio_plot.png", dpi=160)
plt.close()
...
plt.title("Hubble gate window probe clean v2: H0-equivalent")
plt.legend(fontsize=8)
plt.tight_layout()
plt.savefig(OUTDIR / "hubble_gate_window_clean_v2_h0_equivalent_plot.png", dpi=160)
plt.close()
...
plt.xlabel("z")
plt.ylabel("|G(z) - 1|")
plt.title("Hubble gate window probe clean v2: recovery behavior")
plt.legend(fontsize=8)
plt.tight_layout()
plt.savefig(OUTDIR / "hubble_gate_window_clean_v2_recovery_plot.png", dpi=160)
plt.close()

print("")
print("TAIRID Hubble gate window probe clean v2 complete.")
print("Created:")
print("  hubble_gate_window_probe_clean_v2_outputs/hubble_gate_window_probe_clean_v2_summary.json")
print("  hubble_gate_window_probe_clean_v2_outputs/hubble_gate_window_probe_clean_v2_summary.csv")
print("  hubble_gate_window_probe_clean_v2_outputs/hubble_gate_window_probe_clean_v2_summary.txt")
print("  hubble_gate_window_probe_clean_v2_outputs/hubble_gate_window_clean_v2_ratio_plot.png")
print("  hubble_gate_window_probe_clean_v2_outputs/hubble_gate_window_clean_v2_h0_equivalent_plot.png")
print("  hubble_gate_window_probe_clean_v2_outputs/hubble_gate_window_clean_v2_recovery_plot.png")
print("")
print("Boundary:")
